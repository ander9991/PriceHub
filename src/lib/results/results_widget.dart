...
class _ResultsWidgetState extends State<ResultsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('RESULTS_PAGE_Results_ON_PAGE_LOAD');
      logFirebaseEvent('Results_update_local_state');
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final resultsEBayResponse = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                                ...
                                return FutureBuilder<ApiCallResponse>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return InkWell(
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'RESULTS_PAGE_Card_q1u2g191_ON_TAP');
