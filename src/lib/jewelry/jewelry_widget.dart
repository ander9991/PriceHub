...
class JewelryWidget extends StatefulWidget {
  ...
  @override
  _JewelryWidgetState createState() => _JewelryWidgetState();
}
...
class _JewelryWidgetState extends State<JewelryWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'jewelry'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('JEWELRY_arrow_back_rounded_ICN_ON_TAP');
                            ...
                            return FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'JEWELRY_PAGE_Card_riye33c8_ON_TAP');
