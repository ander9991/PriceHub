...
class WholeFoodsWidget extends StatefulWidget {
  const WholeFoodsWidget({
    Key? key,
    this.results,
  }) : super(key: key);
  ...
  @override
  _WholeFoodsWidgetState createState() => _WholeFoodsWidgetState();
}

class _WholeFoodsWidgetState extends State<WholeFoodsWidget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();

  @override
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'WholeFoods'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('WHOLE_FOODS_arrow_back_rounded_ICN_ON_TA');
                            ...
                            return FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'WHOLE_FOODS_PAGE_Card_mmf03htz_ON_TAP');
