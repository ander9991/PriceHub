...
class VideoGamesWidget extends StatefulWidget {
  const VideoGamesWidget({
    Key? key,
    this.results,
  }) : super(key: key);
  ...
  @override
  _VideoGamesWidgetState createState() => _VideoGamesWidgetState();
}

class _VideoGamesWidgetState extends State<VideoGamesWidget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();

  @override
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'VideoGames'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('VIDEO_GAMES_arrow_back_rounded_ICN_ON_TA');
                            ...
                            return FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'VIDEO_GAMES_PAGE_Card_xivfn099_ON_TAP');
