...
class ToysWidget extends StatefulWidget {
  ...
  @override
  _ToysWidgetState createState() => _ToysWidgetState();
}
...
class _ToysWidgetState extends State<ToysWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Toys'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('TOYS_PAGE_arrow_back_rounded_ICN_ON_TAP');
                                ...
                                return Card(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final containerEBayResponse =
                                          snapshot.data!;
                                      return InkWell(
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'TOYS_PAGE_Container_mfdvd2w5_ON_TAP');
                                          logFirebaseEvent(
