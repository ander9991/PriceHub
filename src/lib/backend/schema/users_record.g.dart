    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'Password':
          ...
          break;
        case 'Lname':
          result.lname.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  ListBuilder<String>? _lname;
  ListBuilder<String> get lname => _$this._lname ??= new ListBuilder<String>();
  set lname(ListBuilder<String>? lname) => _$this._lname = lname;
